...
// CSS for the grid and hexagon background (add this to your global CSS file)
const styles = `
@layer utilities {
  .bg-grid {
    background-image: 
...
// You can include this style in your component if you don't want to add it to your global CSS

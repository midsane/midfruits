...
export const Root = ({ children }) => {
    ...
    return (isSmallScreen ? <MobileView /> :
        <div className="overflow-hidden" >
            <Background>
                {showToast && <Toast showToast={showToast} msg="enter a valid name" setShowToast={setShowToast} />}
                <Title />
                <AnimatePresence>
                ...
                <AnimatePresence>
                    {username === "" && <motion.div
                        ...
                        className="fixed z-50 overflow-hidden rounded-full flex justify-center items-center bg-pink-300 p-60 left-1/2 top-1/2  translate-x-[-50%] translate-y-[-50%] " ><dialog className="rounded-lg p-8" open>
